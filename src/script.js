...
function generatorDesserts(event) {
  ...
  let context =
    "You are a chef, creating delicious easy to-make desserts. Please include a LIST of ingredients and instructions on how to make. Please, make it short, and provide a empty line between ingredients and instructions.";
